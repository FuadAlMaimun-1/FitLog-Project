      ...
      <section className="w-full bg-[#18181b] border border-zinc-800/80 rounded-2xl my-6 p-5 md:p-12 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 space-y-4 max-w-2xl text-left">
            ...
            {/* Main Heading */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-oswald font-[900] uppercase tracking-tight leading-none text-white">
            ...
            <div className="pt-2">
              <button className="inline-flex items-center gap-2 bg-[#ccff00] text-black text-xs sm:text-sm font-bold uppercase px-6 py-3.5 rounded-lg hover:bg-[#b8e600] transition-all duration-200 shadow-lg shadow-[#ccff00]/10">
